...
public class UpdateChartResponse2 {
...
String[] idp;
	public UpdateChartResponse2(){}
	public UpdateChartResponse2(ArrayList<ProfileChart> chartList) {
		super();
	...
	public ArrayList<ProfileChart> getChartList() {
		...
		int l = fn.length;
		for(int i = 0; i< l;i++){
			chartList.add(new ProfileChart(fn[i],ln[i],age[i],uhr[i],date[i],idp[i]));
